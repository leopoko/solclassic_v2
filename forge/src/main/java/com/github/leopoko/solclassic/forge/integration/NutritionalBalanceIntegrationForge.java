...
/**
 * Nutritional Balance MOD連携（Forge版）。
 ...
 */
public class NutritionalBalanceIntegrationForge {
    ...
    public static void register() {
        MinecraftForge.EVENT_BUS.register(NutritionalBalanceIntegrationForge.class);
    }
